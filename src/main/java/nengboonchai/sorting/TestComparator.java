...
class Music {
    ...
    public Music(String n, double r, int y) {
        this.n = n;
        this.r = r;
        this.y = y;
    }
...
class Rating implements Comparator<Music> {
...
class NameCompare implements Comparator<Music> {
    public int compare(Music m1, Music m2) {
...
public class TestComparator {
    public static void main(String[] args) {
        ...
        m.add(new Music("Force Awakens", 8.3, 2015));
        m.add(new Music("Star Wars", 8.7, 1977));
        m.add(new Music("Empire Strikes Back", 8.8, 1980));
